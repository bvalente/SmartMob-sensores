...
#SmartMob
#Infrared Avoidance Sensor Module with Enable

import RPi.GPIO as GPIO

SignalPin = 16 # change to the pin you want to use
EnablePin = 18 # change to the pin you want to use
...
def detect(): # returns 1 if obstacle is detected
    try:
        edge = GPIO.wait_for_edge(SignalPin, GPIO.FALLING) # you can add a time limit as a
